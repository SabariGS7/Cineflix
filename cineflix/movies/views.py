...
from .models import Movie,IndustryChoices,GenreChoices,ArtistChoices,LanguageChoices,CerificationChoices
...
#         return render(request,'movies/movie-create.html',context=data)
    ...
    # def post(self,request,*args,**kwargs):
        ...
        # Movie.objects.create(name=name,photo=photo,description=description,release_date=release_date,runtime=runtime,certification=certification,industry=industry,genre=genre,artists=artists,video=video,tags=tags,languages=languages)
